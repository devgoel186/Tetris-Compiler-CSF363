...
class Tetris:
    ...
    def init_game(self) -> None:
        ...
        pygame.time.set_timer(pygame.USEREVENT+1, speed if speed > 25 else 25 ) # 1000 ms is the time for each step the shape takes
    ...
    def draw(self) -> None:
        pygame.draw.line(self.screen, WHITE, (self.rlim + 1, 0), (self.rlim + 1, self.height - 1))
